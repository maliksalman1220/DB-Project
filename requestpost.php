...
<section class="mb-4">
    ...
    <!--Section heading-->
    <h2 class=" font-weight-bold text-center mx-4 jumbotron my-4">Post Your Requests</h2>
        ...
        <div class="col-md-12 mb-md-0 mb-5">
            <form action="requestupdate.php" method="get">
                ...
                <div class="row m-0">
                    ...
                    <div class="col-md-6">
                        <div class="md-form mb-0">
                            <label for='RequiredDeliveryDays'>Required Delivey Days: </label>
                            <input type="int" name="RequiredDeliveryDays" class="form-control" placeholder="Enter Required Delivery Days">
